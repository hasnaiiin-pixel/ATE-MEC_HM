/**
 * DiagnosticEngine - diagnostica automatica degli step falliti. Traduce valori fuori limite in cause probabili e controlli consigliati.
 *
 ...
 */
import { TestStep } from '../runtime/RecipeEngine';
...
export class DiagnosticEngine {
  public static analyzeFailure(step: TestStep, measuredValue: any): Diagnosis {
    ...
    if (step.type === 'DigitalOutputSet') {
      const measured: any = measuredValue || {};
